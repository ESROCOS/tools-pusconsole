...
from Views.Views_Ui.Ui_NewConnectionView import Ui_NewConnectionView


class NewConnectionView:
    """
    This class represents a window. It references the class
    Ui_NewConnectionView, that class is where the graphics
    are created
    """
    resizeFlag = False
    ...
    def __init__(self):
        ...
        self.window = Ui_NewConnectionView()
    ...
    def resize_elements(self, event):
        ...
        our NewConnectionView window responsive
