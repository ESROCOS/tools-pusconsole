...
PYBIND11_MODULE(pus_packet, m) {
	...
	packet
		...
		.def("pus_getApid", &pus_getApid, "Binding for pus_getApid")
		.def("pus_setApid", &pus_setApid, "Binding for pus_setApid")
		.def("pus_getSecondaryHeaderFlag", &pus_getSecondaryHeaderFlag, "Binding for pus_getSecondaryHeaderFlag")
		.def("pus_setSecondaryHeaderFlag", &pus_setSecondaryHeaderFlag, "Binding for pus_setSecondaryHeaderFlag")
		...
		.def("pus_getSequenceCount", &pus_getSequenceCount, "Binding for pus_getSequenceCount")
		.def("pus_setSequenceCount", &pus_setSequenceCount, "Binding for pus_setSequenceCount")
		.def("pus_getPacketDataLength", &pus_getPacketDataLength, "Binding for pus_getPacketDataLength")
		.def("pus_setPacketDataLength", &pus_setPacketDataLength, "Binding for pus_setPacketDataLength")
		.def("pus_setPacketDataNone", &pus_setPacketDataNone, "Binding for pus_setPacketDataNone")
		...
		.def("pus_getTmService", &pus_getTmService, "Binding for pus_getTmService")
		.def("pus_setTmService", &pus_setTmService, "Binding for pus_setTmService")
		.def("pus_getTmSubtype", &pus_getTmSubtype, "Binding for pus_getTmSubtype")
		.def("pus_setTmSubtype", &pus_setTmSubtype, "Binding for pus_setTmSubtype")
		.def("pus_getTcService", &pus_getTcService, "Binding for pus_getTcService")
		.def("pus_setTcService", &pus_setTcService, "Binding for pus_setTcService")
		.def("pus_getTcSubtype", &pus_getTcSubtype, "Binding for pus_getTcSubtype")
		.def("pus_setTcSubtype", &pus_setTcSubtype, "Binding for pus_setTcSubtype")
		.def("pus_getTmTimeReferenceStatus", &pus_getTmTimeReferenceStatus, "Binding for pus_getTmTimeReferenceStatus")
		.def("pus_setTmTimeReferenceStatus", &pus_setTmTimeReferenceStatus, "Binding for pus_setTmTimeReferenceStatus")
		.def("pus_getTmMessageTypeCounter", &pus_getTmMessageTypeCounter, "Binding for pus_getTmMessageTypeCounter")
		.def("pus_setTmMessageTypeCounter", &pus_setTmMessageTypeCounter, "Binding for pus_setTmMessageTypeCounter")
		.def("pus_getTmDestination", &pus_getTmDestination, "Binding for pus_getTmDestination")
		.def("pus_setTmDestination", &pus_setTmDestination, "Binding for pus_setTmDestination")
		.def("pus_getTcSource", &pus_getTcSource, "Binding for pus_getTcSource")
		.def("pus_setTcSource", &pus_setTcSource, "Binding for pus_setTcSource")
		...
		.def("pus_setTmPacketTimeNow", &pus_setTmPacketTimeNow, "Binding for pus_setTmPacketTimeNow")
		.def("pus_getTcAckFlagAcceptance", &pus_getTcAckFlagAcceptance, "Binding for pus_getTcAckFlagAcceptance")
		.def("pus_getTcAckFlagStart", &pus_getTcAckFlagStart, "Binding for pus_getTcAckFlagStart")
		.def("pus_getTcAckFlagProgress", &pus_getTcAckFlagProgress, "Binding for pus_getTcAckFlagProgress")
		.def("pus_getTcAckFlagCompletion", &pus_getTcAckFlagCompletion, "Binding for pus_getTcAckFlagCompletion")
		.def("pus_setTcAckFlags", &pus_setTcAckFlags, "Binding for pus_setTcAckFlags")
		.def("pus_getPacketDataKind", &pus_getPacketDataKind, "Binding for pus_getPacketDataKind")
		.def("pus_setPacketDataKind", &pus_setPacketDataKind, "Binding for pus_setPacketDataKind")
		.def("pus_getTmDataKind", &pus_getTmDataKind, "Binding for pus_getTmDataKind")
		.def("pus_setTmDataKind", &pus_setTmDataKind, "Binding for pus_setTmDataKind")
		.def("pus_getTmNoHeaderDataKind", &pus_getTmNoHeaderDataKind, "Binding for pus_getTmNoHeaderDataKind")
		.def("pus_setTmNoHeaderDataKind", &pus_setTmNoHeaderDataKind, "Binding for pus_setTmNoHeaderDataKind")
		.def("pus_incrementSequenceCount", &pus_incrementSequenceCount, "Binding for pus_incrementSequenceCount")
		.def("pus_setPacketTimeNow", &pus_setPacketTimeNow, "Binding for pus_setPacketTimeNow")
		.def("pus_setPacketDefaults", &pus_setPacketDefaults, "Binding for pus_setPacketDefaults")
