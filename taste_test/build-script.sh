...
cd "$SKELS" && rm -f console.zip && zip console console/* && cd $OLDPWD

cd "$SKELS" && rm -f roberto.zip && zip roberto roberto/* && cd $OLDPWD
...
cd "$CWD" && assert-builder-ocarina.py \
	...
	-o "$OUTPUTDIR" \
	--subC console:"$SKELS"/console.zip \
	--subC roberto:"$SKELS"/roberto.zip \
